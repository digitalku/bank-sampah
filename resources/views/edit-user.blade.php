        ...
        <div class="card card-success">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror">{{ $users->alamat}}</textarea>
              @error('alamat')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
            ...
            <div class="form-group">
              ...
              <select name="role_id" class="form-control @error('role_id') is-invalid @enderror">
                ...
                @foreach($whenpetugas as $whenpetugas)
                  @if($whenpetugas->id == $users->role_id)
                  <option value="{{ $whenpetugas->id }}" selected>{{ $whenpetugas->name }}</option>
                  @else
                  <option value="{{ $whenpetugas->id }}">{{ $whenpetugas->name }}</option>
                  @endif
                @endforeach
                @else
